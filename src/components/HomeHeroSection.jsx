    ...
    <>
      ...
      <Container className="hero-container d-flex align-items-center" style={{ color: '#FFFFFF' }} fluid>
        <Row className="home-hero-content">
          <Col sm={12}><h2>{props.content_start} <br /><span  style={{color: '#DD3A3D'}}>{props.content_end}</span></h2></Col>
          <Col sm={12}><h5><span style={{color: '#DD3A3D'}}>| </span> <Typewriter
              words={['Today\'s Revolution', 'Your Manufacturing Partner', 'Delivering Superior Service']}
              loop={{}}
              cursor
              cursorStyle='|'
              typeSpeed={70}
